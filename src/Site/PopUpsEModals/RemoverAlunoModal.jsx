...
const RemoverAlunoModal = ({ isOpen, onClose, onConfirm, nomeAluno }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-3xl border-4 border-blue-500">
        <div className="p-12">
          {/* Título */}
          ...
          <div className="bg-[#2C3E50] rounded-xl p-6 mb-12 flex items-start gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-white mb-2">Aviso</h3>
          ...
          <div className="flex items-center justify-between gap-8">
            <button
              onClick={onClose}
              className="flex-1 px-8 py-4 text-2xl font-semibold text-gray-800 hover:bg-gray-100 rounded-xl transition-colors"
            >
              Cancelar
            </button>
            <button
